...
-   **Reasoning:** This forces Debian to disable the direct root account login and automatically adds the primary user to the group. This is easier and arguably safer than having a user with the same password as root.

### Software Selection

In the *tasksel* menu (blue screen near the end), we selected:
